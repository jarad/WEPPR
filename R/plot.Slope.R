...
#'
#' @param slp a Slope object
#' @param n a positive integer indicating how many points to evaluate for drawing
#' @param plots a charcter vector indicating whether to draw the "slope", "elevation", or both
...
#' plot_Slope(slp)
#'
plot_Slope <- function(slp, n = 1001, plots = c("slope","elevation")) {
  if (!require(ggplot2))
