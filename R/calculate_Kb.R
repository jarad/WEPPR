...
#'  @export
#'
#' @source page 14 of <https://www.ars.usda.gov/ARSUserFiles/50201000/WEPP/usersum.pdf>
#' @seealso \link{ffective_hydraulic_conductivity}
#'
#' @example
...
#'
#' @format A data.frame with 43 rows and these 10 columns:
#' \desribe{
